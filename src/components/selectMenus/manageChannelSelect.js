...
export const customId = 'manage_channel_select';
...
export async function execute(interaction) {
  ...
  try {
    // Get the selected value (format: manage_channel:channelId)
    const selectedValue = interaction.values[0];
    const channelId = selectedValue.split(':')[1];
    ...
    console.error('Error in manageChannelSelect:', error);
