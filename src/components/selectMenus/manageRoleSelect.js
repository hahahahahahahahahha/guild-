...
export const customId = 'manage_role_select';
...
export async function execute(interaction) {
  ...
  try {
    // Get the selected value (format: manage_role:roleId)
    const selectedValue = interaction.values[0];
    const roleId = selectedValue.split(':')[1];
    ...
    console.error('Error in manageRoleSelect:', error);
